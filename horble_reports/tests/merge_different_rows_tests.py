...
class MergeDifferentRowsTest(BaseReportTest):
    def test_merge_rows(self):
        ...
        result_rows = r.merge_rows(rh1, rh2)
    ...
    def test_merge_data(self):
        ...
        result_data = r.merge_data(m1, m2, mrh, rh1, rh2)
    ...
    def test_merge_matrices(self):
        ...
        expected_m = ((1, 2, 100), (0, 0, 300), (3, 4, 200))
        (result_rh, result_ch, result_m) = r.merge_matrices((rh1, ch1, m1), (rh2, ch2, m2))
    ...
    def test_merge_reports(self):
           ...
           report2 = r.report_builder(data_set=data_set2, 
