...
from marvin.report.lib.base_report_test import BaseReportTest
...
class ReportTest(BaseReportTest):     
    def test_split(self):
        ...
        (row_headers, column_headers, data_matrix) = _build_matrix(data_set, row_key=lambda x: (x[0], x[1]), column_key=lambda x:x[2], value_key=lambda x:x[3])

        (rh1, m1), (rh2, m2) = split_matrix(key=lambda x: x[0], row_headers=row_headers, data_matrix=data_matrix)
    ...
    def test_join(self):
        ...
        (row_headers, data_matrix) = join_matrices((rh1, m1), (rh2, m2))
    ...
    def test_sum_groups(self):
        ...
        report = report_builder(data_set=data_set, 
    ...
    def test_get_fiscal_date(self):
        d = datetime(2008, 6, 1, 0, 0, 0)
        self.assertEquals(datetime(2007, 6, 2, 0, 0, 0), get_fiscal_date(d, 6, 2))
        self.assertEquals(datetime(2008, 6, 1, 0, 0, 0), get_fiscal_date(d, 6, 1))
        self.assertEquals(datetime(2008, 5, 31, 0, 0, 0), get_fiscal_date(d, 5, 31))
    ...
    def test_merge_matrices(self):
        ...
        (result_rh, result_ch, result_m) = merge_matrices((rh1, ch1, m1), (rh2, ch2, m2))
    ...
    def test_replace_into_tuple(self):
        t1 = (0, 1, 2, 3, 4, 5)
        self.assertEquals((0, 1, 2, 9, 4, 5), replace_into_tuple(t1, 9, 3))
        self.assertEquals((9, 1, 2, 3, 4, 5), replace_into_tuple(t1, 9, 0))
        self.assertEquals((0, 1, 2, 3, 4, 9), replace_into_tuple(t1, 9, 5))
        self.assertEquals((0, 1, 2, 3, 4, 5, 9), replace_into_tuple(t1, 9, 6))
    ...
    def test_prepend_column(self):
        ...
        self.assertEquals(expected, prepend_column(ds, column))
    ...
    def test_prepend_row(self):
        ...
        self.assertEquals(expected, prepend_row(ds, column))
    ...
    def test_append_column(self):
        ...
        self.assertEquals(expected, append_column(ds, column))
        
    def test_sum_columns(self):
        ds = ((1, 2, 3), (4, 5, 6), (7, 8, 9))
        expected = (12, 15, 18)
        
        self.assertEquals(expected, reduce_columns(ds, sum))
        
    def test_average_columns(self):
        ds = ((1, 2, 3), (4, 5, 6), (7, 8, 9))
        expected = (4, 5, 6)
        
        self.assertEquals(expected, reduce_columns(ds, lambda x: sum(x)/len(x)))
        
    def test_sum_rows(self):
        ds = ((1, 2, 3), (4, 5, 6), (7, 8, 9))
        expected = (6, 15, 24)
        
        self.assertEquals(expected, reduce_rows(ds, sum))
    ...
    def test_build_matrix(self):
        ...
        (row_headers, column_headers, data_matrix) = _build_matrix(data_set, row_key=lambda x: (x[0],), column_key=lambda x:x[1], value_key=lambda x:x[2])
    ...
    def test_merge_reports(self):
         ...
         report2 = report_builder(data_set=data_set2, 
    ...
    def test_transpose_column(self):
        ...
        self.assertEquals((1, 6, 1), transpose_column(matrix, 0))
        self.assertEquals((2, 7, 2), transpose_column(matrix, 1))
        self.assertEquals((3, 8, 3), transpose_column(matrix, 2))
        self.assertEquals((4, 9, 4), transpose_column(matrix, 3))
        self.assertEquals((5, 0, 5), transpose_column(matrix, 4))